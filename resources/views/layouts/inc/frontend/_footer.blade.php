        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p>
                        {{$appSetting->meta_description ?: 'meta description'}}
                    </p>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{url('/blog')}}" class="text-white">Blog</a></div>
                    <div class="mb-2"><a href="{{url('/site-maps')}}" class="text-white">SiteMaps</a></div>
                </div>
                <div class="col-md-3">
