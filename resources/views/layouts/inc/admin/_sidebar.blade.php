    ...
    <ul class="nav">
        ...
        <li class="nav-item {{ request()->routeIs('category.*') ? 'active' : ''  }}">
            ...
            <div class="collapse {{ request()->routeIs('category.*') ? 'show' : ''  }}" id="category">
                <ul class="nav flex-column sub-menu"><li class="nav-item"> <a class="nav-link {{ request()->routeIs('category.index')  ? 'active' : ''  }}" href="{{ route('category.index')  }}">View Category</a></li>
        ...
        <li class="nav-item {{ request()->routeIs('users.index') ? 'active' : ''  }}">
            ...
            <div class="collapse {{ request()->routeIs('users.*') ? 'show' : ''  }}" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
