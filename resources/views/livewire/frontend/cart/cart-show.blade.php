        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        @forelse($cart as $cartItem)
                                                ...
                                                <label class="product-name">
                                                    ...
                                                    @if($cartItem->productColor)
                                                        @if($cartItem->productColor->color)
                                                            <span class="attribute">Color: {{ $cartItem->productColor->color->name }}</span>
                                                        @endif
                                                    @endif

                                                    @if($cartItem->productSize)
                                                            @if($cartItem->productSize->size)
                                                                <span class="attribute">Size: {{ $cartItem->productSize->size->name }}</span>
                                                            @endif
                                                        @endif
                            ...
                            @endif
                        @empty
                            <h5 class="text-center p-3 text-muted">There are no products added to the cart</h5>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>Get the best deals & Offers <a href="{{route('collections')}}">shop now</a></h5>
                </div>
