                        ...
                        <table class="table align-middle table-fixed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate" style="max-width: 200px;">{{$entity->title}}</td>
                                    <td class="text-truncate" style="max-width: 200px;">{{$entity->description}}</td>
                                    <td>
                                        <img src="{{asset($entity->image)}}" style="width: 70px; height:70px "  alt="img">
                                    </td>
                                    <td>
                                        @if ($entity->status == '1')
