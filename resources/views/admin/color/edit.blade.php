...
<div class="row">
    <div class="col-md-12 grid-margin">
        <div class="card">
            ...
            <div class="card-body">
                <form class="forms-sample" method="post" action="{{ route($pageName.'.update',$entity->id) }}">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="name">Name</label>
                        <input name="name" value="{{ $entity->name }}" type="text" class="form-control" id="name" placeholder="name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input name="code" value="{{ $entity->code }}" type="text" class="form-control" id="code" placeholder="code">
                        @error('code')
                        <small class="text-danger"> {{ $message }} </small>
                        @enderror
                    </div>
